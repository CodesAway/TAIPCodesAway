# Reference: https://github.com/talonhub/community/blob/main/core/edit_text_file/edit_text_file.py
# (tweaked slightly for my needs and to ensure no conflicts with community)
...
@mod.action_class
class Actions:
    def taip_edit_text_file(file: str):
